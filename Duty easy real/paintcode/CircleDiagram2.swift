...
class CircleDiagram2: NSObject {
    ...
    class func drawUntitled(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 204), resizing: ResizingBehavior = .aspectFit) {
        ...
        do {
            ...
            /// Circle 2
            let circle2 = NSMutableAttributedString(string: "Circle 2")
            circle2.addAttribute(.font, value: UIFont(name: "Helvetica", size: 18)!, range: NSRange(location: 0, length: circle2.length))
            do {
                let paragraphStyle = NSMutableParagraphStyle()
                paragraphStyle.alignment = .center
                circle2.addAttribute(.paragraphStyle, value: paragraphStyle, range: NSRange(location: 0, length: circle2.length))
            }
            context.saveGState()
            circle2.draw(at: CGPoint(x: 69, y: 89))
        ...
        oval.lineWidth = 1
        UIColor(hue: 0.551, saturation: 0.93, brightness: 0.879, alpha: 1).setStroke()
        oval.stroke()
        context.restoreGState()
        ...
        do {
            ...
            oval3.fill()
            oval3.lineWidth = 1
            UIColor(hue: 0.59, saturation: 0.89, brightness: 0.444, alpha: 1).setStroke()
            oval3.stroke()
        }
        context.endTransparencyLayer()
        context.restoreGState()
        ...
        context.beginTransparencyLayer(auxiliaryInfo: nil)
        do {
            context.translateBy(x: 508, y: 247)
            UIColor(hue: 0.59, saturation: 0.674, brightness: 0.886, alpha: 1).setFill()
            oval6.fill()
            oval6.lineWidth = 1
            UIColor(hue: 0.98, saturation: 0.991, brightness: 0.816, alpha: 1).setStroke()
        ...
        context.beginTransparencyLayer(auxiliaryInfo: nil)
        do {
            context.translateBy(x: 523, y: 77)
            UIColor(hue: 0.59, saturation: 0.674, brightness: 0.886, alpha: 1).setFill()
            oval8.fill()
            oval8.lineWidth = 1
            UIColor(hue: 0.98, saturation: 0.991, brightness: 0.816, alpha: 1).setStroke()
